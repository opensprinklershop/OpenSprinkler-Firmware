...
#define OS_FW_MINOR      221  // Firmware minor version
...
enum {
	...
	IOPT_WIFI_MODEM_SLEEP, ///< ESP8266 WiFi modem sleep: 0 = off/full power (default, fewer disconnects); 1 = modem sleep (lower power, better weak-signal RX)
