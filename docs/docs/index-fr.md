...
!!! info "Version du firmware OpenSprinklerShop"
    Le firmware OpenSprinklerShop, y compris OpenSprinklerPro, utilise sa propre numérotation de version indépendamment de la ligne upstream du firmware OpenSprinkler. La version actuelle du firmware OpenSprinklerShop est **2.4.0(227)**.
