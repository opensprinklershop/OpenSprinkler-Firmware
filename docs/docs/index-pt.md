...
!!! info "Versão do firmware do OpenSprinklerShop"
    O firmware do OpenSprinklerShop, incluindo o OpenSprinklerPro, usa sua própria numeração de versão de firmware independente da linha de firmware oficial do OpenSprinkler. A versão atual do firmware do OpenSprinklerShop é **2.4.0(208)**.
