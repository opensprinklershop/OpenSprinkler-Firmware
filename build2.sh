#!/bin/bash
	...
	if [ "$GPIO_SIMULATION" == "1" ]; then
        ...
        g++ -o OpenSprinkler -DOSPI -DENABLE_DEBUG $USEGPIO $ADS1115 $PCF8591 -DSMTP_OPENSSL -DHAVE_TINY_WEBSOCKETS $DEBUG -std=c++17 -include string.h -include cstdint main.cpp \
            ...
            smtp.c RCSwitch.cpp psram_utils.cpp TimeLib.cpp debug_log.cpp sensor*.cpp special_station_handlers.cpp notifier.cpp naett.c \
